...
void frm_config_add_function(char* func_name, int (*f)(void))
{
...
void* frm_config_get_instance(const char* instance_name)
{
    unsigned char inst_idx = fnv1a_hash((const unsigned char *)instance_name) % INST_TABLE_SIZE;
...
(int*)(void) frm_config_get_function(const char* func)
{
    unsigned char func_idx = fnv1a_hash((const unsigned char *)func) % FUNC_TABLE_SIZE;
...
/// @param func (const char*) - name of the function to call
/// @return pointer to function
//(int*)(void*, char*) frm_config_get_function_sprintf(const char* instance_name)
int (*frm_config_get_function_sprintf(const char* instance_name))(void*, char*)
{
  const unsigned char function_name[128];
  snprintf(function_name, sizeof(function_name), "%s_sprintf", instance_name);
  unsigned char func_idx = fnv1a_hash((const unsigned char *)function_name) % FUNC_TABLE_SIZE;
  return func_table[func_idx];  // ((int*)(void*, char*))
}
